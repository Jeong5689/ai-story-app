      ...
      <main className="min-h-screen bg-linear-to-b from-purple-50 to-white">
        ...
        <div className="max-w-3xl mx-auto px-4 py-12">
          ...
          <div className="bg-white rounded-2xl shadow-sm p-8">
            {imagePreview && (
              <div className="relative w-full mb-8 max-h-96 h-96 overflow-hidden rounded-2xl shadow-sm">
                <Image
                  src={imagePreview}
                  alt="동화 표지"
                  fill
              ...
              <div className="relative">
                <div className="relative w-full h-80 overflow-hidden rounded-2xl">
                  <Image
                    ...
                    fill
                    className="object-cover"
                    unoptimized // AI나 유저 업로드 이미지의 최적화 에러 방지
                  />
                </div>
                <button
              ...
              {imagePreview && (
                <div className="relative w-full h-48 mb-4 overflow-hidden rounded-xl">
                  <Image
                    ...
                    fill
                    className="object-cover"
                    unoptimized // 외부 링크나 base64, blob 주소여도 에러가 나지 않도록 처리
                  />
                </div>
              )}
              {title && (
